                            ...
                            <form role="form" method="POST" action="registro.php">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative mb-3">
                                        ...
                                        <input class="form-control" placeholder="Email Laboral" type="email" name="email"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="text-center">
                                    <button type="submit" name="btnRegistrarUsuario" id="btnRegistrarUsuario" class="btn btn-primary mt-4">Crear cuenta</button>
                                </div>
                            </form>
                        </div>
                    </div>
